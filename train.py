...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if best_acc < val_acc:
            torch.save(model.state_dict(), "weights/distance/best_model(tiny+cbam).pth")
            best_acc = val_acc
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default="datasets/distance/figure_enhanced")
    # parser.add_argument('--data-path', type=str,
    #                     default="classified_all")
    ...
    # parser.add_argument('--weights', type=str, default='./weights/best_model(crystal_init_tiny).pth',
    #                     help='initial weights path')
